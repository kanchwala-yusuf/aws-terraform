...
#CloudFront distribution with an S3 origin. Not secure if minimum protocol version is TLSv1
resource "aws_cloudfront_distribution" "s3-distribution-TLS-v1" {
  ...
  viewer_certificate {
    ...
    minimum_protocol_version       = "TLSv1.2_2018" #expected version is TLSv1.1 or TLSv1.2 
  }
